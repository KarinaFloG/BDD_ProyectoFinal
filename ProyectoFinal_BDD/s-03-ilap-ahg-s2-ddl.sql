...
CREATE TABLE LAPTOP_F5_AHG_S2(
    ...
    CONSTRAINT TIPO_PROCESADOR_R_AHG_S2_FK FOREIGN KEY (TIPO_PROCESADOR_ID)
    REFERENCES TIPO_PROCESADOR_R_AHG_S2(TIPO_PROCESADOR_ID) ON DELETE cascade,
    CONSTRAINT TIPO_TARJETA_VIDEO_R_AHG_S4_FK FOREIGN KEY (TIPO_TARJETA_VIDEO_ID)
    REFERENCES TIPO_TARJETA_VIDEO_R_AHG_S2(TIPO_TARJETA_VIDEO_ID) ON DELETE cascade,
    CONSTRAINT TIPO_ALMACENAMIENTO_R_AHG_S2_FK FOREIGN KEY (TIPO_ALMACENAMIENTO_ID)
    REFERENCES TIPO_ALMACENAMIENTO_R_AHG_S2(TIPO_ALMACENAMIENTO_ID) ON DELETE cascade,
    CONSTRAINT TIPO_MONITOR_R_AHG_S2_FK FOREIGN KEY (TIPO_MONITOR_ID)
...
CREATE TABLE SUCURSAL_TALLER_F2_AHG_S2(
    ...
    CONSTRAINT SUCURSAL_F2_AHG_S2_FK FOREIGN KEY (SUCURSAL_ID)
...
CREATE TABLE SERVICIO_LAPTOP_F2_AHG_S2(
    ...
    CONSTRAINT SUCURSAL_TALLER_F2_AHG_S2_FK FOREIGN KEY (SUCURSAL_ID)
