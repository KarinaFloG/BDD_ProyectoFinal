...
Prompt Creacion de sinonimos en kfgbdd_s2
Prompt - - - - - - - - - - - - - - - - - - - - 
--sucursal
...
create or replace synonym sucursal_f4 for sucursal_f4_kfg_s2;
--sucursal taller
...
create or replace synonym sucursal_taller_f4 for sucursal_taller_f4_kfg_s2;
--sucursal venta
...
create or replace synonym sucursal_venta_f4 for sucursal_venta_f4_kfg_s2;
--servicio laptop
...
--tipo procesador
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_kfg_s2;
create or replace synonym tipo_procesador_r2 for tipo_procesador_r_kfg_s1@kfgbdd_s1;
