...
Prompt - - - - - - - - - - - - - - - - - - - - 
--sucursal
create or replace synonym sucursal_f1 for sucursal_f2_ahg_s2;
create or replace synonym sucursal_f2 for sucursal_f1_ahg_s1@ahgbdd_s1; 
...
--sucursal taller
create or replace synonym sucursal_taller_f1 for sucursal_taller_f2_ahg_s2;
create or replace synonym sucursal_taller_f2 for sucursal_taller_f1_ahg_s1@ahgbdd_s1; 
...
--sucursal venta
create or replace synonym sucursal_venta_f1 for sucursal_venta_f2_ahg_s2;
create or replace synonym sucursal_venta_f2 for sucursal_venta_f1_ahg_s1@ahgbdd_s1; 
...
--servicio laptop
create or replace synonym servicio_laptop_f1 for servicio_laptop_f2_ahg_s2;
create or replace synonym servicio_laptop_f2 for servicio_laptop_f1_ahg_s1@ahgbdd_s1; 
...
--laptop inventario
create or replace synonym laptop_inventario_f1 for laptop_inventario_f2_ahg_s1@ahgbdd_s1;
create or replace synonym laptop_inventario_f2 for laptop_inventario_f1_kfg_s1@kfgbdd_s1;
--laptop
create or replace synonym laptop_f1 for laptop_f5_ahg_s2;
...
create or replace synonym laptop_f4 for laptop_f3_kfg_s2@kfgbdd_s2;
--tipo monitor
