...
Prompt Creacion de sinonimos en kfgbdd_s1
Prompt - - - - - - - - - - - - - - - - - - - - 
--sucursal
...
create or replace synonym sucursal_f3 for sucursal_f3_kfg_s1;
...
create or replace synonym sucursal_taller_f3 for sucursal_taller_f3_kfg_s1;
...
create or replace synonym sucursal_venta_f3 for sucursal_venta_f3_kfg_s1;
...
create or replace synonym servicio_laptop_f3 for servicio_laptop_f3_kfg_s1;
...
--laptop
<<<<<<< HEAD
create or replace synonym laptop_f1 for laptop_f2_kfg_s2;
=======
create or replace synonym laptop_f1 for laptop_f1_kfg_s2@kfgbdd_s2;
>>>>>>> f580fd62db53e40ec8c0295eabcdc907baee534e
