...
grant create session, create table, create procedure, create sequence, create view, create synonym, create trigger to ilap_bdd;
grant create database link, create any directory to ilap_bdd;