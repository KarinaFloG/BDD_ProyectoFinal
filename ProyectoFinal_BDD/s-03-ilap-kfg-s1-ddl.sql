...
CREATE TABLE LAPTOP_F4_KFG_S1(
    ...
    CONSTRAINT TIPO_PROCESADOR_R_KFG_S1_FK FOREIGN KEY (TIPO_PROCESADOR_ID)
    REFERENCES TIPO_PROCESADOR_R_KFG_S1(TIPO_PROCESADOR_ID) ON DELETE cascade,
    CONSTRAINT TIPO_TARJETA_VIDEO_R_KFG_S4_FK FOREIGN KEY (TIPO_TARJETA_VIDEO_ID)
    REFERENCES TIPO_TARJETA_VIDEO_R_KFG_S1(TIPO_TARJETA_VIDEO_ID) ON DELETE cascade,
    CONSTRAINT TIPO_ALMACENAMIENTO_R_KFG_S1_FK FOREIGN KEY (TIPO_ALMACENAMIENTO_ID)
    REFERENCES TIPO_ALMACENAMIENTO_R_KFG_S1(TIPO_ALMACENAMIENTO_ID) ON DELETE cascade,
    CONSTRAINT TIPO_MONITOR_R_KFG_S1_FK FOREIGN KEY (TIPO_MONITOR_ID)
...
CREATE TABLE SUCURSAL_TALLER_F3_KFG_S1(
    ...
    CONSTRAINT SUCURSAL_F3_KFG_S1_FK FOREIGN KEY (SUCURSAL_ID)
...
CREATE TABLE SERVICIO_LAPTOP_F3_KFG_S1(
    ...
    CONSTRAINT SUCURSAL_TALLER_F3_KFG_S1_FK FOREIGN KEY (SUCURSAL_ID)
